...
export function mapMachineryHours(r: any) {
  ...
  return {
    ...
    tripsBy: r.trips_by ?? null,
    tripsByName: r.trips_by_name ?? null,
    tripsAt: r.trips_at ?? null,
...
export function mapCheckout(r: any) {
  ...
  return {
    ...
    returnReqDate: r.return_req_date ? toDateOnly(r.return_req_date) : null,
    returnReqCondition: r.return_req_condition ?? null,
    returnReqNotes: r.return_req_notes ?? null,
