...
export const VACATION_TYPES = [
  "اعتيادية", "عارضة", "رسمية", "سنوية", "مرضية", "بدون مرتب", "بدل سهرة",
];

export const VALID_STATUSES = new Set([
  "حاضر", "سهر", "عارضة حضور", "عارضة إجازة", "إجازة عارضة", "إجازة مرضية", "إجازة رسمية", "إجازة سنوية", "غياب", "بدون مرتب", "إجازة اعتيادية", "بدل سهرة", "",
]);
